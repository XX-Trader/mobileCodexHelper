...
export const isSupportedLanguage = (value) => (
  typeof value === 'string' && languages.some((lang) => lang.value === value)
);
...
const getInitialLanguage = () => getStoredLanguagePreference() || DEFAULT_LANGUAGE;
...
export const applyLanguagePreference = async (language) => {
  const resolvedLanguage = persistLanguagePreference(language);
